...
class AssassinsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1a = Player(id="+1", realname="player1a", codename="p1a",\
                team="Team1", state="ALIVE", role="DEMO")
        self.team1.demo = "+1"
        self.p1a.put()
        ...
        self.p1c = Player(id="+3", realname="player1c", codename="p1c",\
                team="Team1", state="ALIVE", role="MEDIC")
        self.team1.medic="+3"
        self.p1c.put()
        self.team1.put()
        ...
        self.p2a = Player(id="+4", realname="player2a", codename="p2a",\
                team="Team2", state="ALIVE", role="DEMO")
        self.team2.demo = "+4"
        self.p2a.put()
        self.p2b = Player(id="+5", realname="player2b", codename="p2b",\
                team="Team2", state="DEAD", role="SNIPER")
        self.team2.sniper="+5"
        self.p2b.put()
